...
def action():	
	bch = raw_input('\n  \033[1;92mENTER HERE ANY NUMBER \033[1;95m▶▶▶▶ \033[1;97m  ')
	if bch =='':
		...
		try:
			c = raw_input(" \033[1;92mSELECTED CODE \033[1;97m:\033[1;95m ")
			k="+923"
			idlist = ('.txt')
		...
		try:
			c = raw_input(" \033[1;92mSELECTED CODE \033[1;97m: ")
			k="+923"
			idlist = ('.txt')
			for line in open(idlist,"r").readlines():
				id.append(line.strip())
...
#	    menu()
	...
	time.sleep(0.5)
	psb ('[!] Press CTRL Then Press z To Stop This Process')
	time.sleep(0.5)
	print 50*'-'
	print
